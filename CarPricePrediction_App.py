...
model = joblib.load(r"C:\Users\bhara\CarDheko\preprocessing\car_price_prediction_model.pkl")
...
data = pd.read_csv(r"C:\Users\bhara\CarDheko\structured\car_dheko_cleaned_dataset_raw.csv")
